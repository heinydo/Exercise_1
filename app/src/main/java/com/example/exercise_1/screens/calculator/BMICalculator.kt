...
import com.example.exercise_1.databinding.FragmentBmiCalculateBinding
...
class BMICalculator : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var binding: FragmentBmiCalculateBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_bmi__calculate, container,  false)
